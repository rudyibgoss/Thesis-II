...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('transportation', '0022_delete_vehicle'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('documents', models.FileField(upload_to='Car Documents')),
                ...
                ('fuels', models.CharField(choices=[('diesel', 'Diesel'), ('gasoline', 'Gasoline'), ('electric', 'Electric'), ('hybrid', 'Hybrid'), ('plug_in_hybrid', 'Plug-in Hybrid'), ('cng', 'Compressed Natural Gas (CNG)'), ('lpg', 'Liquefied Petroleum Gas (LPG)'), ('hydrogen', 'Hydrogen'), ('ethanol', 'Ethanol'), ('biodiesel', 'Biodiesel'), ('synthetic', 'Synthetic Fuel (eFuel)')], max_length=50)),
                ...
                ('plate', models.CharField(max_length=50, verbose_name='Plate Number')),
